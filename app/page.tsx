...
const Home = () => {
  return (
    <section className="h-full">
      {/* top section */}
      <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 py-2">
        <div className="py-4">
          <h1 className="text-blue-500 text-xl sm:text-2xl lg:text-3xl py-2">
            Hi, my name is
          </h1>
          <h2 className="text-4xl text-slate-200 sm:text-5xl md:text-6xl lg:text-7xl font-semibold">
            Abdus Sattar
          </h2>
